"""enhancing_spam_comment_detection URL Configuration
...
from enhancing_spam_comment_detection import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Spam_Comment_Status/$', remoteuser.Predict_Spam_Comment_Status, name="Predict_Spam_Comment_Status"),
    ...
    url(r'^VView_Predicted_Spam_Comment_Type_Ratio/$', serviceprovider.View_Predicted_Spam_Comment_Type_Ratio, name="View_Predicted_Spam_Comment_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Spam_Comment_Status/$', serviceprovider.View_Predicted_Spam_Comment_Status, name="View_Predicted_Spam_Comment_Status"),
