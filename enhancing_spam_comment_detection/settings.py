...
ROOT_URLCONF = 'enhancing_spam_comment_detection.urls'
...
WSGI_APPLICATION = 'enhancing_spam_comment_detection.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'enhancing_spam_comment_detection',
        'USER':'root',
        'PASSWORD': 'Meena@2003',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
