...
--
-- Host: localhost
-- Generation Time: Sep 13, 2023 at 08:18 AM
...
--
-- Database: `enhancing_spam_comment_detection`
--
CREATE DATABASE IF NOT EXISTS `enhancing_spam_comment_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `enhancing_spam_comment_detection`;
...
('9qa7js0swyopumcq3i1hnhqtoaayf1yu', 'eyJ1c2VyaWQiOjR9:1qdWt8:F898qqjQ-vmfELntF7wVd9PbQFrbZbzFdSMxCP6Fask', '2023-09-19 14:18:42.210182'),
...
('swhfmus8lh12k07vtpp32jh5xwa5ieul', 'eyJ1c2VyaWQiOjN9:1qdTvY:Z_dVg7F_kZmQATDTVyzMQ4jneF9Hkxex94ifbmcefu8', '2023-09-19 11:09:00.144283'),
...
(3, 'Govind', 'Govind123@gmail.com', 'Govind', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(11, 'KNeighborsClassifier', '91.42857142857143'),
(12, 'Random Forest Classifier', '95.71428571428572'),
(13, 'SVM', '98.57142857142858'),
(14, 'Logistic Regression', '97.14285714285714'),
(15, 'Gradient Boosting Classifier', '94.28571428571428'),
(16, 'Decision Tree Classifier', '94.28571428571428');
...
(13, 'Normal Comment', '33.33333333333333'),
(14, 'Spam Comment', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_spam`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_spam` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `COMMENT_ID` varchar(300) NOT NULL,
  `AUTHOR` varchar(300) NOT NULL,
  `CDATE` varchar(300) NOT NULL,
  `CONTENT_DESC` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `remote_user_detect_spam`
--

INSERT INTO `remote_user_detect_spam` (`id`, `COMMENT_ID`, `AUTHOR`, `CDATE`, `CONTENT_DESC`, `Prediction`) VALUES
(1, 'z13ttt1jcraqexk2o234ghbgzxymz1zzi04', 'Cony', '2022-11-28T16:01:47', 'You should check my channel for Funny VIDEOS!!ï»¿\r\n', 'Spam Comment'),
(2, 'z12axnji5w2axxht522thb3bktvqjdlbp04', 'zhichao wang', '2022-11-29T02:13:56', 'i think about 100 millions of the views come from people who only wanted to  check the viewsï»¿\r\n', 'Normal Comment'),
(3, 'LZQPQhLyRh9y57URF7qpZRk3MVAJNLNhhZga_5YWBU8', 'Living4Techno', '2022-12-25T19:46:26', 'marketglory . com/strategygame/andrijamatf earn real money from game\r\n', 'Spam Comment');
